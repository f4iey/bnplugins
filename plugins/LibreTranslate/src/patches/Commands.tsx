...
import { LibreTranslate } from "../api"
...
export default () => registerCommand({
    ...
    description: "Send a message using Dislate in any language chosen, using the LibreTranslate API.",
    displayDescription: "Send a message using Dislate in any language chosen, using the LibreTranslate API.",
    applicationId: "-1",
    ...
    options: [
        ...
        },
        {
            ...
            description: "The language that LT will translate the text into. This can be any language from the list.",
            displayDescription: "The language that LT will translate the text into. This can be any language from the list.",
            type: ApplicationCommandOptionType.STRING as number,
            // @ts-ignore
            choices: [...langOptions],
            required: true
